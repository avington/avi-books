...
const ROUTES: Routes = [
  {path: '', component: MyBookShelvesComponent, canActivate: [CheckMyShelvesGuard, CheckIsAuthenticatedGuard]},
  {path: 'book-shelf/:bookShelfId', component: MyBookShelfComponent, canActivate: [CheckBookSelfExistGuard, CheckIsAuthenticatedGuard]},
  {path: 'search', component: SearchContainerComponent, canActivate: [CheckIsAuthenticatedGuard]}
];
